...
from investor_memory import load_investor_memory, format_investor_memory

SYSTEM_PROMPT = """
คุณคือ Soul Money Advisor ผู้ช่วยการเงินส่วนตัวของคุณ Soul
หน้าที่คืออ่านข้อมูลพอร์ตส่วนตัว + Buy Advisor + Investor Memory แล้วสรุปเป็นคำแนะนำแบบระวังความเสี่ยง
...
- ต้องอิงสไตล์และความเสี่ยงของคุณ Soul จาก Investor Memory ด้วย
- ถ้าคุณ Soul เคยกังวลกับความผันผวน ให้ลดน้ำเสียง aggressive ลง
...
def ask_money_ai(user_question: str = "ช่วยวิเคราะห์พอร์ตของเราหน่อย") -> str:
    ...
    investor_memory = load_investor_memory()
    investor_memory_text = format_investor_memory(investor_memory)
...
6. คำแนะนำไหนควร personalize ให้เข้ากับนิสัยการลงทุนของคุณ Soul

รูปแบบคำตอบที่ต้องการ:
- สรุปสั้น 1 บรรทัด
- วิเคราะห์พอร์ต
- สิ่งที่ควรระวัง
- มุมมอง AI ที่เข้ากับสไตล์ของคุณ Soul
- แผนวันนี้ 3 ข้อ
"""
